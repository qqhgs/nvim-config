...
M.setup = function()
  ...
  for mode, mappings in pairs(Ryn.keymaps.mode) do
    mode = Ryn.keymaps.adapters[mode]
  ...
  vim.cmd "silent! command PackerClean lua require 'ryn.config.packer' require('packer').clean()"
  vim.cmd "silent! command PackerCompile lua require 'ryn.config.packer' require('packer').compile()"
  vim.cmd "silent! command PackerInstall lua require 'ryn.config.packer' require('packer').install()"
  vim.cmd "silent! command PackerStatus lua require 'ryn.config.packer' require('packer').status()"
  vim.cmd "silent! command PackerSync lua require 'ryn.config.packer' require('packer').sync()"
  vim.cmd "silent! command PackerUpdate lua require 'ryn.config.packer' require('packer').update()"
  vim.cmd "silent! command PackerProfile lua require 'ryn.config.packer' require('packer').profile_output()"
end
