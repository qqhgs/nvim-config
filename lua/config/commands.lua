...
--   pattern = { "*.html" },
--   callback = function()
--     if vim.fn.expand("%:e") == "html" and vim.fn.search("{{") ~= 0 then vim.cmd("set filetype=gohtmltmpl") end
--   end,
-- })
...
-- Highlight on yank
vim.cmd("au TextYankPost * lua vim.highlight.on_yank {higroup = 'Search', timeout = 200}")
